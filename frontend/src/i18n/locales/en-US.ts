...
\
  ...
  model: {
    ...
    editor: {
      ...
      truncateTokensLabel: 'Input Token Limit',
      truncateTokensPlaceholder: 'e.g. 8192',
      truncateTokensDesc: 'Single embedding input limit. 0 or empty uses the system default. Ollama uses this as num_ctx.',
  ...
  modelSettings: {
    ...
    toasts: {
      ...
      truncateTokensInvalid: 'Input token limit must be an integer from 0 to 8192',
