export default {
  ...
  model: {
    ...
    editor: {
      ...
      truncateTokensLabel: "输入 Token 上限",
      truncateTokensPlaceholder: "例如：8192",
      truncateTokensDesc: "传给 Embedding 模型的单次输入上限。0 或留空表示使用系统默认；Ollama 会作为 num_ctx 使用。",
  ...
  modelSettings: {
    ...
    toasts: {
      ...
      truncateTokensInvalid: "输入 Token 上限必须是 0-8192 的整数",
      updated: "模型已更新",
      added: "模型已添加",
      saveFailed: "保存模型失败",
      deleted: "模型已删除",
